...
evidencias, se encuentra en \texttt{postman/} del repositorio del backend. A
continuaci\'on se presentan las capturas de las peticiones ejecutadas (registro,
...
\begin{itemize}[leftmargin=1.2cm]
  ...
  \item Anexo B: colecci\'on Postman y entornos (\texttt{postman/}).
