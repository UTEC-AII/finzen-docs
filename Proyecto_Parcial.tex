...
\begin{itemize}[leftmargin=1.2cm]
  \item \textbf{Anexo A} --- Prompt del prototipo:
        \href{https://github.com/UTEC-AII/finzen-docs/blob/main/frontend-prompt/prompt.md}{frontend-prompt/prompt.md}.
  \item \textbf{Anexo B} --- Colecci\'on Postman y entornos:
        \href{https://github.com/UTEC-AII/finzen-docs/tree/main/postman}{postman/}.
  \item \textbf{Anexo C} --- Cat\'alogo completo de APIs:
        \href{https://github.com/UTEC-AII/finzen-docs/blob/main/CATALOGO_DE_APIS.md}{CATALOGO\_DE\_APIS.md}.
