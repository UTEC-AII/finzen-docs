...
Del an\'alisis comparativo se observa que los competidores coinciden en dos ejes: la
\textbf{simplicidad de uso} (PocketGuard) y la \textbf{automatizaci\'on con IA}
(Copilot Money, Monarch Money y YNAB). Todos ellos dependen, en mayor o menor medida,
de \textbf{vincular cuentas bancarias}. FinZen adopta la interacci\'on en lenguaje
natural de Copilot Money y Monarch Money, pero elimina esa dependencia: el usuario
registra sus movimientos de forma manual y consulta al asistente sobre ellos, sin
